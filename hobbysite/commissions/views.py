...
from .forms import CommissionForm, CommissionUpdateForm  # Assuming these forms exist
...
def commission_create(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            commission.author = request.user  # Assuming there is an author field in your model
            commission.save()
            return redirect(reverse('commissions:commission_detail', args=[commission.pk]))
    else:
        form = CommissionForm()
